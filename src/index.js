 ...
 *    GET /audio?id=<videoId>            -> best audio (json)
 *    GET /proxy?id=<videoId>&itag=<opt> -> streams media bytes (Range OK)
 *    GET /redirect?id=<videoId>         -> 302 to best audio url
...
function chooseAudio(formats, preferItag) {
  ...
  // Preferred itags for Telegram VC bots: 140 (m4a 128k), 251 (opus 160k), 139 (m4a 48k)
